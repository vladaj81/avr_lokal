...
if (isset($_POST['niz_slanje'])) {
    ...
    if ($_POST['period'] == 'pocetna godina') {
    ...
    if ($_POST['period'] == 'krajnja godina') {
...
if (isset($_POST['funkcija']) && $_POST['funkcija'] == 'troskovi pribave') {
    ...
    $tabela = '<table class="tabela_pribava izvoz_excel">
                <thead>
                    <tr>
                        <th>VO</th>
                        <th>Konto</th>
    ...
    $tabela_suma = '<table class="tabela_suma izvoz_excel">
                        <thead>
                            <tr>
                                <th>VO</th>
                                <th>Suma po VO</th>
    ...
    $tabela_kljuc = '<table class="tabela_kljuc izvoz_excel">
                        <thead>
                            <tr>
                                <th>Konto</th>
                                <th>Opis</th>
    ...
    //KREIRANJE TABELE SA TROSKOVIMA PO KLJUCU
    $tabela_obracun_pribave = '<table class="tabela_obracun_pribave izvoz_excel">
                                <thead>
                                    <tr>
                                        <th>Šifra VO</th>
...
if (isset($_POST['naziv_funkcije']) && $_POST['naziv_funkcije'] == 'ukupni_obracun_avr') {
    ...
    $pocetni_datum_zaglavlje = $_POST['tabela_pocetni_datum'];
    ...
    if(isset($_POST['zbir_krajnja_god'])) {
        ...
        $krajnji_datum_zaglavlje = $_POST['tabela_krajnji_datum'];
    ...
    if(isset($_POST['zbir_pocetna_god']) && !isset($_POST['zbir_krajnja_god'])) {
