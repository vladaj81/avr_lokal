...
if (isset($_POST)) {
	...
	if (isset($_POST['troskovi_pocetna'])) {
		...
		//KREIRANJE NIZA ZA GENERISANJE TABELE SA TROSKOVIMA ZA POCETNU GODDINU
		$niz_xls = json_decode($_POST['troskovi_pocetna'],true);

		//KREIRANJE KOLONA ZA PRVU TABELU
		$kolone_za_xls = ['Grupa', 'Sektor', 'Konto','Opis', 'Iznos'];
		...
		$kolone_za_xls2 = ['GRUPA', '1', '2', '3', '4', '6', 'SUMA PO GRUPAMA'];
		...
		$kolone_za_xls3 = ['Koeficijent', 'Čist trošak', 'Deo ključ', 'Ukupno'];
		...
		$troskovi_pribava_xls = json_decode($_POST['troskovi_pribava_pocetna'], true);

		//KREIRANJE NIZA ZA GENERISANJE TABELE SA OBRACUNOM PRIBAVE ZA POCETNU GODINU
		$obracun_pribava_xls = json_decode($_POST['obracun_pribava_pocetna'], true);

		//KREIRANJE KOLONA ZA PRVU TABELU
		$kolone_troskovi_xls = ['Grupa', 'Sektor', 'Konto','Opis', 'Iznos'];
		$broj_kolona_troskovi = count($kolone_troskovi_xls);

		//KREIRANJE KOLONA ZA DRUGU TABELU
		$kolone_obracun_xls = ['VO', 'Konto', 'Opis', 'Čisti Trošak'];
		...
		if ($_POST['godina_klizna'] == 'false') {
			...
			$kolone_avr_xls = ['Šifra VO', 'Ukupno troškovi bez AVR','Prenosna/Premija', $naslov_cetvrta_kolona];
	...
	if (isset($_POST['troskovi_krajnja'])) {
		...
		$niz_xls4 = json_decode($_POST['troskovi_krajnja'],true);

		//KREIRANJE KOLONA ZA PRVU TABELU
		$kolone_za_xls4 = ['Grupa', 'Sektor', 'Konto', 'Opis', 'Iznos'];
		...
		//KREIRANJE KOLONA ZA DRUGU TABELU
		$kolone_za_xls5 = ['GRUPA', '1', '2', '3', '4', '6', 'SUMA PO GRUPAMA'];
		...
		//KREIRANJE KOLONA ZA TRECU TABELU
		$kolone_za_xls6 = ['Koeficijent', 'Čist trošak', 'Deo ključ', 'Ukupno'];
		...
		//KREIRANJE NIZA ZA GENERISANJE TABELE SA TROSKOVIMA ZA KRAJNJU GODINU
		$troskovi_pribava_xls2 = json_decode($_POST['troskovi_pribava_krajnja'], true);

		//KREIRANJE NIZA ZA GENERISANJE TABELE SA OBRACUNOM PRIBAVE ZA KRAJNJU GODINU
		$obracun_pribava_xls2 = json_decode($_POST['obracun_pribava_krajnja'], true);

		//KREIRANJE KOLONA ZA PRVU TABELU
		$kolone_troskovi_xls2 = ['Grupa', 'Sektor', 'Konto','Opis', 'Iznos'];
		$broj_kolona_troskovi2 = count($kolone_troskovi_xls2);

		//KREIRANJE KOLONA ZA DRUGU TABELU
		$kolone_obracun_xls2 = ['VO', 'Konto', 'Opis', 'Čisti Trošak'];
		...
		//KREIRANJE KOLONA ZA TRECU TABELU
		$kolone_suma_xls2 = ['VO', 'Suma po VO'];
		$broj_kolona_suma2 = count($kolone_suma_xls2);

		//KREIRANJE KOLONA ZA TABELU SA KOEFICIJENTIMA
		$kolone_koef_xls2 = ['Sektor', 'Koeficijent'];
		$broj_kolona_koef2 = count($kolone_koef_xls2);
		
		//KREIRANJE KOLONA ZA TABELU SA TROSKOVIMA SA KLJUCA
		$kolone_kljuc_xls2 = ['Konto', 'Opis', 'Iznos'];
		$broj_kolona_kljuc2 = count($kolone_kljuc_xls2);

		//KREIRANJE KOLONA ZA TABELU SA TROSKOVIMA PRIBAVA + KLJUC
		$kolone_zbir_xls2 = ['Šifra VO', 'Koeficijent Pribava', 'Ključ pribava', 'Direktno pribava', 'Direktno + Ključ'];
		...
		$avr_xls2 = json_decode($_POST['avr_obe'], true);
		...
		//KREIRANJE KOLONA ZA TABELU SA AVR-OM
		$kolone_avr_xls2 = ['Šifra VO', $naslov_druga_kolona, $naslov_treca_kolona, 'Ukupno troškovi bez AVR', 'Prenosna/Premija', $naslov_sesta_kolona, $naslov_sedma_kolona, $naslov_osma_kolona];
	...
	*/
	...
	$putanja_excel_fajla = str_replace(__FILE__,$_SERVER['DOCUMENT_ROOT'] .'/avr/dodaci/AVR.xls',__FILE__);
	...
	echo json_encode('http://localhost/avr/dodaci/AVR.xls');
